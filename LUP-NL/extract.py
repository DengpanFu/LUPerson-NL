...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='extract images from LUP-NL raw videos and detected bboxes.')
    parser.add_argument('-v',  '--vid_dir',  type=str,  default='videos')
    parser.add_argument('-d',  '--det_dir',  type=str,  default='dets')
    parser.add_argument('-s',  '--save_dir', type=str,  default='lup-nl')
